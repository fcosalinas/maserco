...
describe "itemblocks/new" do
  before(:each) do
    assign(:itemblock, stub_model(Itemblock,
      :quantity => 1.5,
      :cdi => 1.5,
      :cdo => 1.5
    ).as_new_record)
  ...
  it "renders new itemblock form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => itemblocks_path, :method => "post" do
